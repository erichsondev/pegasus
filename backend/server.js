/*
 * =================================================================
 * PEGASUS FINANCE 2.0 - SERVIDOR TURBINADO (COM ROTA ADMIN)
 * =================================================================
 */
...
// --- 6. FUNÇÃO DE LIMPEZA E REGENERAÇÃO (ATUALIZADA PARA 60 MESES) ---
async function limparEGerarFuturos(dataReferencia, usuarioId) {
    ...
    // 1. Apaga futuros a partir da data de referência
    ...
    // 2. Recria próximos 60 meses (5 ANOS)
    // O loop foi aumentado de 12 para 60
    ...
    for (let i = 0; i < 60; i++) {
        ...
        // Limpa o mês alvo para garantir que não duplique
...
rotasProtegidas.get('/resumo', asyncHandler(async (req, res) => {
    ...
    // Apenas calcula, não gera mais nada aqui (Corrigido anteriormente)
...
rotasProtegidas.delete('/lancamentos-fixos/:id', asyncHandler(async (req, res) => {
    ...
    // DATA VEM DO BANCO COMO OBJETO. AQUI ELA É PASSADA PARA A FUNÇÃO QUE AGORA TRATA ISSO.
...
// --- ROTA ADMIN SECRETA (ADICIONADA AQUI) ---
